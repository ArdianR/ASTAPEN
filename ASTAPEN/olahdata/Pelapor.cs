...
namespace ASTAPEN.olahdata
{
    public partial class Pelapor : Form
    {
        ...
        private void adfd_Click(object sender, EventArgs e)
        {

        }

        private void txtInIdPel_TextChanged(object sender, EventArgs e)
        {
            txtInIdPel.MaxLength = 16;
        }
        ...
        private void txtInIdPel_KeyPress(object sender, KeyPressEventArgs e)
        {
